...
// Representation of the comment structure of the service
type Comment struct {
	ID     string
	Slug   string
	Body   string
...
// Defines all the methods the service needs in order to operate
...
// Struct on with all logic will be build on top of
type Service struct {
	Store Store
}
